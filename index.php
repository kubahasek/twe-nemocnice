    ...
    <table class="w-full border border-gray-500 text-left mt-3">
      ...
      <?php foreach($data as $d): ?>
        <tr class="border border-gray-500">
          ...
          <td class="border border-gray-500 p-2"><a href="/patient.php?id=<?= $d["patientId"] ?>" class="text-blue-500 underline"><?= $d["name"] ?></a></td>
          <td class="border border-gray-500 p-2"><a href="/procedure.php?id=<?= $d["procedureId"] ?>" class="text-blue-500 underline"><?= $d["procedureNum"] ?></a> <?= $d["procedureName"] ?></td>
        </tr>
      <?php endforeach; ?>
    </table>
  </div>
